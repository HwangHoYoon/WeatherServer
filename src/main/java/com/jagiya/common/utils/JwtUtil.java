package com.jagiya.common.utils;
...
import com.jagiya.common.service.UserDetailsServiceImpl;
...
public class JwtUtil {
    ...
    private static final long REFRESH_TIME =  365 * 24 * 60 * 60 * 1000L;
    ...
    public Boolean refreshTokenValidation(String token) {
        ...
        // DB에 저장한 토큰 비교
        Optional<Token> refreshToken = tokenRepository.findByUserUserId(getIdFromToken(token));
